...
abstract class View implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\View\\Model\\Map\\ViewTableMap';
     ...
     *
     * @return View The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ViewTableMap::ID] = true;
        }
    ...
    public function setView($v)
    {
        ...
        if ($this->view !== $v) {
            $this->view = $v;
            $this->modifiedColumns[ViewTableMap::VIEW] = true;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[ViewTableMap::SOURCE] = true;
        }
    ...
    public function setSourceId($v)
    {
        ...
        if ($this->source_id !== $v) {
            $this->source_id = $v;
            $this->modifiedColumns[ViewTableMap::SOURCE_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[ViewTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[ViewTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ViewTableMap::translateFieldName('View', TableMap::TYPE_PHPNAME, $indexType)];
            $this->view = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ViewTableMap::translateFieldName('Source', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ViewTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ViewTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ViewTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ViewTableMap::VIEW)) {
            $modifiedColumns[':p' . $index++]  = 'VIEW';
        }
        if ($this->isColumnModified(ViewTableMap::SOURCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ViewTableMap::ID)) $criteria->add(ViewTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(ViewTableMap::DATABASE_NAME);
        $criteria->add(ViewTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \View\Model\View (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \View\Model\View Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return     ChildView The current object (for fluent API support)
     */
